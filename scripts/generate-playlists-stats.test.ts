...
// Variables that the mock factory will close over
...
beforeEach(() => {
  ...
  vi.mock('fs/promises', () => ({
    readFile: (...args: unknown[]) => mockReadFile(...(args as any)),
    writeFile: (...args: unknown[]) => mockWriteFile(...(args as any)),
    access: (...args: unknown[]) => mockAccess(...(args as any)),
  }));
});
